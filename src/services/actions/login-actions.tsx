import {ActionTypeCreatorFeed, ActionTypeCreatorPayload} from "../../types";
...
export type TLoginSuccessAction = Required<ActionTypeCreatorFeed<loginActions.LOGIN_SUCCESS, {success: boolean, accessToken: string, refreshToken: string, user: {}}>>;
